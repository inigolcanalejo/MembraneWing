...
###########################################################################################
 ...
 Geometry --------------------------------------------------------: -
                                                                  : -
                                                        Grid scale: 1
                                           Reference relation area: 0.005
                              Reference length (pitching momentum): 0.01
                        Reference length (rolling/yawing momentum): 0.5
...
###########################################################################################
 ...
 Files/IO --------------------------------------------------------: -
                                         ...
                                         Boundary mapping filename: (thisfile)
                                             Primary grid filename: /work/piquee/MembraneWing/kratos_fsi_big/Mesh/airfoil_Structured_scaliert.grid
                                                       Grid prefix: /work/piquee/MembraneWing/kratos_fsi_big/Mesh/dg
                                               Output files prefix: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol
...
#                   Set boundary fluxes for forcing function (0/1): 1       					# Settings for Improved Multigrid Scheme
 ...
 Full multigrid --------------------------------------------------: -
                           ...
                           Maximal time step number (coarse grids): 30
...
###########################################################################################
 ...
 Output options --------------------------------------------------: -
                                                                  : -
                                                     Output period: 1
                                               Field output values: v_p_rho_cp_Ptot_mach_vort_Nk_heli_Hn_l2_Q_velgrad_xyzgeod_vxyzgeod
                                                                  : -
                                             Surface output period: 1
                                             Surface output values: p_rho_cp_cfxyz_yplus_fnormal_xyzgeod_vxyzgeod
							          : -
 Monitoring ------------------------------------------------------: -
                                                                  : -
...
###########################################################################################
 ...
 Backward Euler --------------------------------------------------: -
                                                                  : -
                                                     Linear solver: Lusgs
                                     Implicit overrelaxation omega: 1.5
...
Lusgs treat rotating frame of reference source terms implicitly (0/1): 0
 ...
 Timestepsize ----------------------------------------------------: -
                                                                  : -
                                                        CFL number: 8
                                         CFL number (coarse grids): 4
                                         CFL number (large grad p): 4
                                                                  : -
 ...
 Dual time -------------------------------------------------------: -
                    ...
                    Unsteady activate inner iteration output (0/1): 1
                             ...
                             Unsteady computational time step size: -1
                                      Unsteady physical time steps: 5
...
#Motion Description Definition ----------------------------------------------------------
                           ...
                           Motion description id: pitch
                                Type of movement: external
             Evaluate forces and moments at node: MEMBRANE
               Origin of local coordinate system: 0.125 0.0 0.0
#          Degree of Fourier series for rotation: 1
#                 Reduced frequency for rotation: 0.0 0.6 0.0       
...
###########################################################################################
 ...
 -----------------------------------------------------
     ...
     Parameters for RBF group start ------------------:
                          RBF markers specifying group: 2
        RBF basis coordinates and deflections filename: interface_deformfile.nc
                            ...
                            RBF walldistances filename: walldistances_matrix
                                ...
                                RBF radius full weight: 0.5
                                RBF radius zero weight: 1
...
Chimera component output (Tecplot, Ensight Gold) (0/1): 0
 ...
 -----------------------------------------------------
###########################################################################################
 					Finished time steps: 200
###########################################################################################

Restart-data prefix: /work/piquee/MembraneWing/kratos_fsi_big/Restart/Rigid/sol.medium.Alpha.06.pval.unsteady_i=200_t=1.00000e+00
Surface output filename: /work/piquee/MembraneWing/kratos_fsi_big/Restart/Rigid/sol.medium.Alpha.06.surface.pval.unsteady_i=200_t=1.00000e+00 

    tau_main at Tue Jun  2 23:13:45 2020
 Unsteady enable external control over progress in time (0/1): 1
 Unsteady allow external control over progress in time (0/1): 1


    solver at Tue Jun  2 23:14:17 2020
                                              Restart-data prefix: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.pval.deform_i=201_t=1.00500e+00
                                            Reset flow statistics: (none)

    solver at Tue Jun  2 23:14:18 2020
                                          Surface output filename: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.surface.pval.deform_i=201_t=1.00500e+00

    solver at Tue Jun  2 23:14:38 2020
                                              Restart-data prefix: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.pval.deform_i=201_t=1.00500e+00
                                            Reset flow statistics: (none)
                                          Surface output filename: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.surface.pval.deform_i=201_t=1.00500e+00

    deformation at Tue Jun  2 23:16:16 2020
                                            Primary grid filename: /work/piquee/MembraneWing/kratos_fsi_big/Mesh/airfoil_Structured_scaliert.grid.def.1

    solver at Tue Jun  2 23:16:48 2020
                                              Restart-data prefix: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.pval.deform_i=202_t=1.01000e+00

    solver at Tue Jun  2 23:16:48 2020
                                          Surface output filename: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.surface.pval.deform_i=202_t=1.01000e+00

    solver at Tue Jun  2 23:17:09 2020
                                              Restart-data prefix: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.pval.deform_i=202_t=1.01000e+00
                                          Surface output filename: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.surface.pval.deform_i=202_t=1.01000e+00

    deformation at Tue Jun  2 23:18:52 2020
                                            Primary grid filename: /work/piquee/MembraneWing/kratos_fsi_big/Mesh/airfoil_Structured_scaliert.grid.def.2

    solver at Tue Jun  2 23:19:25 2020
                                              Restart-data prefix: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.pval.deform_i=203_t=1.01500e+00

    solver at Tue Jun  2 23:19:25 2020
                                          Surface output filename: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.surface.pval.deform_i=203_t=1.01500e+00

    solver at Tue Jun  2 23:19:45 2020
                                              Restart-data prefix: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.pval.deform_i=203_t=1.01500e+00
                                          Surface output filename: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.surface.pval.deform_i=203_t=1.01500e+00

    deformation at Tue Jun  2 23:21:28 2020
                                            Primary grid filename: /work/piquee/MembraneWing/kratos_fsi_big/Mesh/airfoil_Structured_scaliert.grid.def.3

    solver at Tue Jun  2 23:22:00 2020
                                              Restart-data prefix: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.pval.deform_i=204_t=1.02000e+00

    solver at Tue Jun  2 23:22:00 2020
                                          Surface output filename: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.surface.pval.deform_i=204_t=1.02000e+00

    solver at Tue Jun  2 23:22:21 2020
                                              Restart-data prefix: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.pval.deform_i=204_t=1.02000e+00
                                          Surface output filename: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.surface.pval.deform_i=204_t=1.02000e+00

    deformation at Tue Jun  2 23:24:06 2020
                                            Primary grid filename: /work/piquee/MembraneWing/kratos_fsi_big/Mesh/airfoil_Structured_scaliert.grid.def.4

    solver at Tue Jun  2 23:24:38 2020
                                              Restart-data prefix: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.pval.deform_i=205_t=1.02500e+00

    solver at Tue Jun  2 23:24:38 2020
                                          Surface output filename: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.surface.pval.deform_i=205_t=1.02500e+00

    solver at Tue Jun  2 23:24:59 2020
                                              Restart-data prefix: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.pval.deform_i=205_t=1.02500e+00
                                          Surface output filename: /work/piquee/MembraneWing/kratos_fsi_big/Outputs/airfoilSol.surface.pval.deform_i=205_t=1.02500e+00

    deformation at Tue Jun  2 23:26:47 2020
                                            Primary grid filename: /work/piquee/MembraneWing/kratos_fsi_big/Mesh/airfoil_Structured_scaliert.grid.def.5
